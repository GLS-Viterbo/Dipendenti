...
public class ShiftAssociationRepository {
    ...
    public ShiftAssociation save(ShiftAssociation association) {
        ...
        Long id = jdbcTemplate.queryForObject(
                ...
                association.shiftId(),
                association.dayOfWeek().getValue()
        );
     ...
     * @return optional of shift association
     */
    public Optional<ShiftAssociation> findByEmployeeIdDayOfWeekAndShift(Long employeeId, DayOfWeek dayOfWeek, Long shiftId) {
        String sql = "SELECT * FROM shift_associations WHERE employee_id = ? AND day_of_week = ? AND shift_id = ?";
        return jdbcTemplate.query(sql, rowMapper, employeeId, dayOfWeek.getValue(), shiftId).stream().findFirst();
    }
     ...
     * @return list of shift associations
     */
    public List<ShiftAssociation> findByDayOfWeek(DayOfWeek dayOfWeek) {
        String sql = "SELECT * FROM shift_associations WHERE day_of_week = ? ORDER BY employee_id";
        return jdbcTemplate.query(sql, rowMapper, dayOfWeek.getValue());
    }
     ...
     */
    public List<ShiftAssociation> findAll() {
        String sql = "SELECT * FROM shift_associations ORDER BY employee_id, day_of_week";
