...
public class EmployeeRepository {
    ...
    public Employee save(Employee employee) {
        String sql = """
                ...
                (name, surname, tax_code, birthday, address, city, email, phone, note, deleted)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                RETURNING id
                """;
    ...
    public List<Employee> findAll() {
        String sql = "SELECT * FROM employees WHERE deleted = false";
    ...
    public Page<Employee> findAll(int page, int size) {
        ...
        List<Employee> content = jdbcTemplate.query(sql, rowMapper, size, offset);

        Long totalElements = countActive();

        return new Page<Employee>(content, page, size, countActive());
    }
    ...
    public Long countActive() {
        String sql = "SELECT COUNT(*) FROM employees WHERE deleted = false";
    ...
    public boolean update(Employee employee) {
        String sql = """
                UPDATE employees
                SET name = ?, surname = ?, tax_code = ?, birthday = ?, address = ?, city = ?, email = ?, phone = ?, note = ?, deleted = ?
                WHERE id = ?
                """;
