...
public class CardAssignmentRepository {
    ...
    /**
     * Returns all the assignments of an employee
     * @param employeeId id of employee
     * @return list of assignments
     */
    public List<CardAssignment> getHistoryByEmployee(Long employeeId) {
        String sql = "SELECT id, employee_id, card_id, start_date, end_date " +
                "FROM card_assignments WHERE employee_id = ? ORDER BY start_date DESC";
        return jdbcTemplate.query(sql, rowMapper, employeeId);
    }
